...
from users.views import LoginAPIView, RegistrationAPIView, TokenObtainAPIView, GenerateLoginCodeAPIView,\
    ValidateLoginCodeAPIView, UserView, CustomerDeliveryAddressViewset, ChangeUserPasswordAPIView
...
urlpatterns = [
    ...
    path('change-user-password', ChangeUserPasswordAPIView.as_view(), name='change-user-password'),
]
