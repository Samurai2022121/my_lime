    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients_in_stock', models.ManyToManyField(to='products.Product', verbose_name='Ингриндиенты в наличии')),
                ('recipe_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='recipes.recipecategory', verbose_name='Категория')),
            ],
            options={
                'verbose_name': 'рецепт',
